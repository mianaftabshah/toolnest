...
export const tools: Tool[] = [
  ...
  { slug: 'pdf-editor', name: 'PDF Editor', description: 'Add text, highlight, draw & annotate PDFs', longDescription: '', icon: '✏️', category: 'pdf', categoryLabel: 'PDF Tools', badge: 'New', href: '/tools/pdf-editor', keywords: ['pdf editor', 'annotate pdf', 'edit pdf'] },
  ...
  { slug: 'pdf-split', name: 'Split PDF', description: 'Split a PDF into separate pages or ranges', longDescription: '', icon: '✂️', category: 'pdf', categoryLabel: 'PDF Tools', badge: 'PDF', href: '/tools/pdf-split', keywords: ['split pdf'] },
  { slug: 'pdf-compress', name: 'Compress PDF', description: 'Reduce PDF file size instantly', longDescription: '', icon: '🗜️', category: 'pdf', categoryLabel: 'PDF Tools', badge: 'PDF', href: '/tools/pdf-compress', keywords: ['compress pdf'] },
  { slug: 'pdf-to-images', name: 'PDF to Images', description: 'Convert PDF pages to JPG or PNG', longDescription: '', icon: '🖼️', category: 'pdf', categoryLabel: 'PDF Tools', badge: 'PDF', href: '/tools/pdf-to-images', keywords: ['pdf to image', 'pdf to jpg'] },
  ...
  { slug: 'pdf-page-numbers', name: 'Add Page Numbers', description: 'Add page numbers to your PDF', longDescription: '', icon: '🔢', category: 'pdf', categoryLabel: 'PDF Tools', badge: 'PDF', href: '/tools/pdf-page-numbers', keywords: ['pdf page numbers'] },
  { slug: 'pdf-watermark', name: 'Watermark PDF', description: 'Add a custom text watermark to PDF', longDescription: '', icon: '💧', category: 'pdf', categoryLabel: 'PDF Tools', badge: 'PDF', href: '/tools/pdf-watermark', keywords: ['watermark pdf'] },
  { slug: 'office-to-pdf', name: 'Office to PDF', description: 'Convert Word, Excel, PPT to PDF', longDescription: '', icon: '📑', category: 'pdf', categoryLabel: 'PDF Tools', badge: 'PDF', href: '/tools/office-to-pdf', keywords: ['word to pdf', 'excel to pdf'] },
]
